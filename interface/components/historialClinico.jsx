      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex mb-4 border-b">
          <button 
            ...
            onClick={() => setSeccionActiva('datosPersonales')}
          >
            Datos Personales
          </button>
          <button 
            ...
            onClick={() => setSeccionActiva('antecedentes')}
          >
            Antecedentes
          </button>
          <button 
            ...
            onClick={() => setSeccionActiva('sintomas')}
          >
            Sintomas
          </button>
        </div>
        ...
        <div className="flex justify-between mt-6">
          {seccionActiva === 'datosPersonales' ? (
            ...
            <button
              ...
              onClick={() => {
                if (seccionActiva === 'antecedentes') setSeccionActiva('datosPersonales');
                if (seccionActiva === 'sintomas') setSeccionActiva('antecedentes');
              }}
              disabled={consultaEnviada}
            >
              Anterior
          ...
          {seccionActiva === 'sintomas' ? (
            ...
            <button
              ...
              onClick={() => {
                if (seccionActiva === 'datosPersonales') setSeccionActiva('antecedentes');
                if (seccionActiva === 'antecedentes') setSeccionActiva('sintomas');
              }}
              disabled={consultaEnviada}
            >
              Siguiente
